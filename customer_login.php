...
<style type="text/css">			
	...
	<body>
		...
		<div class="container">
    <h1 class="welcome text-center" align="center" style="color: black">Welcome to <br> the Canteen of SPIPS</h1>
        <div class="card card-container">
        <h2 class='login_title text-center' align="center" style="color: darkgrey">Login using your SPIPS ID</h2>
